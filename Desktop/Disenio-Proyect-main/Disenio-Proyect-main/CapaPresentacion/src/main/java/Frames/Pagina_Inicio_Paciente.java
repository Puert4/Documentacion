 ...
 * @author Arell
 */
public class Pagina_Inicio_Paciente extends javax.swing.JFrame {

    /**
     * Creates new form Pagina_Inicio_Paciente
     */
    public Pagina_Inicio_Paciente() {
        initComponents();
         this.setTitle("Pagina de Inicio Paciente");
        // Configurar la Foto
        Pintar imagen = new Pintar();
        imagen.PintarImagen(ImagenHospital, "src/main/java/Fotos/FotoHospital.png");
    ...
    private void initComponents() {
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"ISSTE", "XXXXX", "09/10/2002", "Dr. Juan L"},
                {"SAN JOSE", "XXXXX", "09/10/2002", "Dra. Christel A"},
                {"IMSS", "XXXXX", "09/10/2002", "Dr. Juan L"},
                {null, null, null, null}
            },
            new String [] {
        ...
        btnSeleccionar.setBackground(new java.awt.Color(153, 204, 255));
        btnSeleccionar.setFont(new java.awt.Font("Roboto", 2, 14)); // NOI18N
        btnSeleccionar.setText("Seleccionar");
        FondoPanel.add(btnSeleccionar, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 160, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pagina_Inicio_Paciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pagina_Inicio_Paciente().setVisible(true);
            }
        });
    }
